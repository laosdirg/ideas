...
Copied from the rust RFC repo :heart:

  - Fork the repo [ideas repository]
  - Copy `0000-template.md` to `text/0000-my-project.md` (where "my-project" is
...
[ideas repository]: https://github.com/laosdirg/ideas
